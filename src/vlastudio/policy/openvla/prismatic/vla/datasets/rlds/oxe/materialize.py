...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.DEXTEROUS, ActionEncoding.EEF_POSE, ActionEncoding.BIMANUAL_EEF_POSE]:
