...
from vlastudio.deploy.action_manager.sync_chunk import SyncChunkManager
from vlastudio.deploy.action_manager.async_chunk_ratio import AsyncChunkRatioManager
...
class EESequenceToQposManager(SyncChunkManager):
    ...
    def _maybe_convert_ee_chunk(self, chunk):
        ...
        from vlastudio.deploy.robot.alicia_d.sequence_ik import solve_sequence
        from vlastudio.deploy.robot.alicia_d.robot import (
            _canonicalize_yaw,
